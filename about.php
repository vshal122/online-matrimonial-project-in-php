  ...
  <div class="container">
   ...
   <div class="about">
   	  ...
   	  <div class="col-md-6 about_right">
   	  	<h1>About us</h1>
   	  	<h4>अब  और भी हुआ आसान .....आइए  हमारे  साथ  और  ढूढ़िये  अपना  जीवन  साथी </h4>
	...
	<div class="container">
		  ...
		  <ul class="posts-grid our-team">
			<li class="list-item-1">
				<figure class="thumbnail_1 thumbnail">
					<a href="#"><img src="images/vishal.jpg"  class="img-responsive" alt=""/></a>
					<div class="post_networks">
						<ul>
							<li class="network_0"><a href="https://www.facebook.com/vishal.malviya.79656/about" title=""><i class="fa fa-facebook"></i></a></li>
						</ul>
					</div>
			    </figure>
			    <div class="desc">
			    	<h4><a href="#">Vishal malviya</a></h4>
	   ...
	   <div class="col-md-3 about_grid1">
		  <ul class="posts-grid our-team">
			<li class="list-item-1">
				<figure class="thumbnail_1 thumbnail">
					<a href="#"><img src="images/ram.jpg"  class="img-responsive" alt=""/></a>
					<div class="post_networks">
						<ul>
			    ...
			    <div class="desc">
			    	<h4><a href="#">Ram Malviya </a></h4>
			    	<p>Director and managment</p>
			    </div>
			 </li>
	       </ul>
	   </div>
